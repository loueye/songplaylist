  ...
  register(`${process.env.BASE_URL}service-worker.js`, {
    ...
    registered () {
      ...
      let contentToCache = [
          ...
          './img/icons/logo.png',
          './img/cover/beastars.jpg',
          './img/cover/castle_ski.jpg',
          './img/cover/howl_moving_castle.jpg',
          './img/cover/kiki_delivery.jpg',
          './img/cover/mononoke.jpg',
          './img/cover/ponyo.jpg',
          './img/cover/porco_rosso.jpg',
          './img/cover/totoro.jpg',
          './img/cover/ultimate_custom.jpg',
          './img/cover/wind_rises.jpg',
